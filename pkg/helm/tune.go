...
const (
	...
	BACKEND_MEDIUM_TOTAL_CPU_THRESHOLD    = "10000m"
	BACKEND_MEDIUM_TOTAL_MEMORY_THRESHOLD = "3672Mi"
	BACKEND_HIGH_TOTAL_CPU_THRESHOLD      = "24000m"
	BACKEND_HIGH_TOTAL_MEMORY_THRESHOLD   = "7544Mi"
